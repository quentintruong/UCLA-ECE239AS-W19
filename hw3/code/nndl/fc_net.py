...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    a2, scores_cache = affine_forward(h1, self.params['W2'], self.params['b2'])
    scores = a2
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    # ================================================================ #    
    loss, dl_da2 = softmax_loss(scores, y)
    loss += 0.5 * self.reg * (np.sum(self.params['W1'] ** 2) + np.sum(self.params['W2'] ** 2))

    dl_dh1, grads['W2'], grads['b2'] = affine_backward(dl_da2, scores_cache)
    dl_dx, grads['W1'], grads['b1'] = affine_relu_backward(dl_dh1, h1_cache)

    grads['W2'] += self.reg * self.params['W2'] # add to address the regularization from gradient of loss wrt W2
    grads['W1'] += self.reg * self.params['W1'] # add to address the regularization from gradient of loss wrt W1
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
