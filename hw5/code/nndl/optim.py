...
def sgd_nesterov_momentum(w, dw, config=None):
  ...
  # ================================================================ #
  v = config['momentum'] * v - config['learning_rate'] * dw
  next_w = w + v + config['momentum'] * (v - config.get('velocity', np.zeros_like(w)))
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def adam(w, dw, config=None):
  ...
  v_tilda = config['v'] / (1-config['beta1'] ** config['t'])
  a_tilda = config['a'] / (1-config['beta2'] ** config['t'])
  next_w = w - config['learning_rate'] / (np.sqrt(a_tilda) + config['epsilon']) * v_tilda
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
