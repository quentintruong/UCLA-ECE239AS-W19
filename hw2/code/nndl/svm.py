...
class SVM(object):
  ...
  def loss(self, X, y):
    ...
    # ================================================================ #
      ...
      loss += np.sum(np.maximum([0], 1 + np.matmul(self.W, X[i]) - np.matmul(self.W[y[i]], X[i]))) - 1
    loss /= num_train
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
  ...
  def loss_and_grad(self, X, y):
    ...
    # ================================================================ #
      ...
      indicators = np.sign(np.maximum([0], 1 + np.matmul(self.W, X[i]) - np.matmul(self.W[y[i]], X[i])))
      indicators[y[i]] = 0
      grad += indicators.reshape(indicators.shape[0], 1) * X[i]
      grad[y[i]] += -np.sum(indicators.reshape(indicators.shape[0], 1) * X[i], axis=0)
  ...
  def fast_loss_and_grad(self, X, y):
    ...
    # ================================================================ #
    loss = (np.sum(np.maximum([0], 1 + np.matmul(X, self.W.transpose()) - np.sum(np.multiply(self.W[y], X), axis=1).reshape(X.shape[0], 1))) - X.shape[0]) / X.shape[0]
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    # ================================================================ #
    indicators = np.sign(np.maximum([0], 1 + np.matmul(X, self.W.transpose()) - np.sum(np.multiply(self.W[y], X), axis=1).reshape(X.shape[0], 1)))
